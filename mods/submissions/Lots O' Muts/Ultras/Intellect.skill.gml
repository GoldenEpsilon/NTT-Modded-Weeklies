...
#define skill_text    return "PRIMARY WEAPON HAS ACCURACY#SECONDARY WEAPON HAS AUTOAIM";
#define skill_tip     return "Putting it to good use";
#define skill_icon    return global.sprSkillHUD;
#define skill_button  sprite_index = global.sprSkillIcon;
#define skill_take    with Player {accuracy /= 2;} if(array_length(instances_matching(mutbutton, "skill", mod_current)) > 0) sound_play(sndBasicUltra);
#define skill_lose    with Player {accuracy *= 2;}
...
with Player if (race == "steroids" && button_check(index,"spec") && canspec && bwep != 0) {
