#define init
global.sprButton = sprite_add("Sprites/Main/Scrap Arms.png", 1, 12, 16)
global.sprIcon = sprite_add("Sprites/Icons/Scrap Arms Icon.png", 1, 8, 8)
...
#define skill_text
	return "@wscraps@s @y(+ammo +reload)@s#drop from enemies#when you have bullet weapons";
...
with(instances_matching(CustomObject, "name", "ScrapArmsPickup")){
	...
	if(instance_nearest(x,y,Player) != noone){
		...
		var pickno = 10 * skill_get(mod_current) + skill_get("magazinefingers")*4;
