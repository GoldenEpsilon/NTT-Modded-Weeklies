...
global.sprButton = sprite_add("Sprites/Main/Mimicry.png", 1, 12, 16)
global.sprIcon = sprite_add("Sprites/Icons/Mimicry Icon.png", 1, 8, 8)
...
#define skill_text
	return "At @gULTRA@s, also choose#@wANOTHER@s mutant's ultra";
		...
		if(instance_exists(EGSkillIcon) || ultraOnscreen){
			...
			if(fork()){
				...
				if(crown_current = 8) { // Crown of Destiny stuff
					...
					var r = irandom(array_length(ultraList) - 1);
					...
					for(var f = 0; f < s; f++) {
						...
						if(attempts == 15){
							skill_create(ultraList[irandom(array_length(ultraList) - 1)], instance_number(mutbutton));
						}
					}
				...
				while((instance_exists(SkillIcon) || instance_exists(EGSkillIcon)) && chosen == -1){
					...
					with(SkillIcon){
						for(var i = 0; i < maxp; i++){
							if(num == 1 && button_pressed(i, "key1")){chosen = "";chosenSkill = skill;}
							if(num == 2 && button_pressed(i, "key2")){chosen = "";chosenSkill = skill;}
							if(num == 3 && button_pressed(i, "key3")){chosen = "";chosenSkill = skill;}
							if(num == 4 && button_pressed(i, "key4")){chosen = "";chosenSkill = skill;}
							if(num == 5 && button_pressed(i, "key5")){chosen = "";chosenSkill = skill;}
							if(num == 6 && button_pressed(i, "key6")){chosen = "";chosenSkill = skill;}
							if(num == 7 && button_pressed(i, "key7")){chosen = "";chosenSkill = skill;}
							if(num == 8 && button_pressed(i, "key8")){chosen = "";chosenSkill = skill;}
							if(num == 9 && button_pressed(i, "key9")){chosen = "";chosenSkill = skill;}
							if(addy == 0 && button_pressed(i, "fire")){chosen = "";chosenSkill = skill;}
						}
					}
					if(chosen != -1){
					...
					with(EGSkillIcon){
						for(var i = 0; i < maxp; i++){
							if(num == 1 && button_pressed(i, "key1")){chosen = race;chosenSkill = skill;}
							if(num == 2 && button_pressed(i, "key2")){chosen = race;chosenSkill = skill;}
							if(num == 3 && button_pressed(i, "key3")){chosen = race;chosenSkill = skill;}
							if(num == 4 && button_pressed(i, "key4")){chosen = race;chosenSkill = skill;}
							if(num == 5 && button_pressed(i, "key5")){chosen = race;chosenSkill = skill;}
							if(num == 6 && button_pressed(i, "key6")){chosen = race;chosenSkill = skill;}
							if(num == 7 && button_pressed(i, "key7")){chosen = race;chosenSkill = skill;}
							if(num == 8 && button_pressed(i, "key8")){chosen = race;chosenSkill = skill;}
							if(num == 9 && button_pressed(i, "key9")){chosen = race;chosenSkill = skill;}
	...
	switch(self[0]){
			...
			switch(self[1]){
				...
				case 1:
					with(instances_matching_ne(Player, "mimcryplant", current_frame)){
						...
						{
							with(instances_matching(Tangle, "creator", self)){
								instance_destroy();
							}
		...
		case "horror":
			switch(self[1]){
				//Stalker
				case 1:
					with(instances_matching_le(hitme, "my_health", 0)){
