#define init
global.sprButton = sprite_add("Sprites/Main/Shattered Skull.png", 1, 12, 16)
global.sprIcon = sprite_add("Sprites/Icons/Shattered Skull Icon.png", 1, 8, 8)
