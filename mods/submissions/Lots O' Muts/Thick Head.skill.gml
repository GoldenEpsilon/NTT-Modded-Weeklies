#define init
global.sprButton = sprite_add("Sprites/Main/Thick Head.png", 1, 12, 16)
global.sprIcon = sprite_add("Sprites/Icons/Thick Head Icon.png", 1, 8, 8)
global.sprIconMini = sprite_add("Sprites/Thick Head Icon Mini.png", 1, 4, 4)
global.surfIcon = -4;
global.chosen = [];
global.skill = -1;
...
#define skill_icon
	if(global.surfIcon == -4 || global.skill == -1){
...
#define skill_take(_num)
	if(_num > 0 && instance_exists(LevCont)){
		...
		if(fork()){
			...
			global.skill = -4; //reset the skill
...
#define skill_lose
	skill_set(global.skill, max(skill_get(global.skill)-1, 0));
...
draw_sprite(global.sprIconMini, 0, 10, 4);
