#define init
	global.sprButton = sprite_add("Sprites/Main/Neural Network.png", 1, 12, 16);
	global.sprIcon   = sprite_add("Sprites/Icons/Neural Network Icon.png", 1, 8, 8);
	global.num = 0;
