...
#define init
global.sprite = sprite_add_weapon("sprites/sprSuperPlasbounceCannon.png",5,8)
...
global.sprHud = sprite_add_weapon("sprites/hudsprites/sprSuperPlasbounceCannonHud.png",1,3.5,);
#define weapon_name
return "Super Plasbounce Cannon";
...
#define weapon_text
return "@(color:16745694)BOUNCING NEVER STOPS";
