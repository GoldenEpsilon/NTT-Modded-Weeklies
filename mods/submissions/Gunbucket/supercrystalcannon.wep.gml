//this amount of crystals under normal conditions would take a very long time to grow, these aren't normal conditions anymore though are they?

#define init
global.sprite = sprite_add_weapon("sprites/sprSuperCrystalCannon.png",3,7)
...
#define weapon_text
return "@(color:16745694)CRYSTILLINE AIHILATION";
