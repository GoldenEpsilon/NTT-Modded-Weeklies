...
#define init
global.sprite = sprite_add_weapon("sprites/sprJoltBouncerShotgun.png",3,4)
...
#define weapon_text
return "@(color:16745694)BOUNCE AND ZAP ZAP ZAP";

#define weapon_fire

    weapon_post(4, -4, 4);
    sound_play_pitchvol(sndBouncerShotgun,1.2,1);
repeat (7){
