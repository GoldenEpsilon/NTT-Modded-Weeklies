...
#define init
global.sprite = sprite_add_weapon("sprites/sprLaserNader.png",1,3)
global.sprLaserNade = sprite_add("sprites/sprLaserNade.png",0,4,4)
global.sprblink = sprite_add("sprites/sprLaserNadeBlink.png",2,4,4)
global.mskShrapnelNade = sprite_add("sprites/mskShrapnelNade.png",0,4,4)

#define weapon_name
return "LASER LAUNCHER";
...
#define weapon_text
return "@(color:16745694)DEADLY LIGHTS";
