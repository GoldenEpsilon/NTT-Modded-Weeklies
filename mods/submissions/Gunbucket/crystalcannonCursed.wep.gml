//!ti gnikam elihw ti ezilaer t'ndid I !hguoht taht enoyna llet t'nod ,seimene secreip taht nonnac kalf a tsuj adnik si siht

#define init
global.sprite = sprite_add_weapon("sprites/sprCrystalCannonCursed.png",1,5)
...
#define weapon_text
return "@q@(color:16745694)IT HURTS";
